...
export const clothingItemStatusEnum = ["pending", "processing", "ready", "failed"] as const;
...
export const clothingItem = pgTable("clothing_item", {
	...
	status: text("status", { enum: clothingItemStatusEnum }).notNull().default("pending"),
	...
	userIdStatusIdx: index("clothing_item_user_id_status_idx").on(table.userId, table.status),
}));

export const clothingCategoryEnum = ["top", "bottom", "shoes", "outerwear", "accessory"] as const;
export type ClothingCategory = typeof clothingCategoryEnum[number];

export const clothingFormalityEnum = ["casual", "smart-casual", "business", "formal"] as const;
export type ClothingFormality = typeof clothingFormalityEnum[number];

export const clothingFitEnum = ["slim", "regular", "loose", "oversized"] as const;
export type ClothingFit = typeof clothingFitEnum[number];

export const clothingSeasonEnum = ["spring", "summer", "fall", "winter"] as const;
export type ClothingSeason = typeof clothingSeasonEnum[number];

export const clothingMetadata = pgTable("clothing_metadata", {
...
export const clothingEmbedding = pgTable("clothing_embedding", {
