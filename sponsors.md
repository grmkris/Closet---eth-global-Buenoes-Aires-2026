...
[layerzero.network](https://layerzero.network/) [layerzero_core](https://twitter.com/LayerZero_Core) [Open page →](/events/buenosaires/prizes/layerzero)
### About
...
### Send Tokens and Call Anything Cross-Chain

Discover how LayerZero’s OFT (Omnichain Fungible Token) standard enables developers to build seamless cross-chain e...

This workshop is happening in-person 06:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 2
...
[pyth.network](https://pyth.network/) [pythnetwork](https://twitter.com/PythNetwork) [Open page →](/events/buenosaires/prizes/pyth-network)
### About
...
⛓️  Most Innovative use of Pyth pull price Feeds ⸺ $10,000 🥇 1st place $4,000 🥈 2nd place $2,500 🥉 3rd place $2,000 🏅 4th place $1,000 🏅 5th place $500 Use Pyth Pull oracle to power up you dapp. The prize will go to the top three teams with best and most innovative use of Pyth Price feeds.
...
<a href="https://ethglob.al/jmacc">Pyth EVM guide https://docs.pyth.network/price-feeds/core/use-real-time-data/pull-integration/evm ↗</a> <a href="https://ethglob.al/2dawy">Pyth contract API Reference https://api-reference.pyth.network/price-feeds/evm/getPriceNoOlderThan ↗</a> <a href="https://ethglob.al/vc0bf">How to fetch data from Hermes https://docs.pyth.network/price-feeds/core/fetch-price-updates ↗</a> <a href="https://ethglob.al/ysocv">Pyth Dev Forum https://dev-forum.pyth.network/ ↗</a> <a href="https://ethglob.al/7f5sr">EVM Error codes https://docs.pyth.network/price-feeds/core/error-codes/evm ↗</a> <a href="https://ethglob.al/4w8jd">Pyth supported price feeds https://docs.pyth.network/price-feeds/core/price-feeds/price-feed-ids ↗</a> <a href="https://ethglob.al/3rj59">Pyth supported Chains https://docs.pyth.network/price-feeds/core/contract-addresses/evm ↗</a> 🎲 Pyth Entropy Pool Prize ⸺ $5,000 Split evenly between all qualifying projects Use Pyth Entropy to generate and consume random number on chains. Anyone can permissionless generate random number on-chain. This pool prize will be given to most Innovative apps to use Pyth Entropy.
### Qualification Requirements
...
<a href="https://ethglob.al/v90wq">Pyth Entropy EVM guide https://docs.pyth.network/entropy/generate-random-numbers/evm ↗</a> <a href="https://ethglob.al/on06y">Pyth Entropy Examples https://github.com/pyth-network/pyth-examples/tree/main/entropy ↗</a> <a href="https://ethglob.al/4fzzw">Pyth Entropy Contract Address https://docs.pyth.network/entropy/contract-addresses ↗</a> <a href="https://ethglob.al/i2r5x">Pyth Entropy Best Practices https://docs.pyth.network/entropy/best-practices ↗</a> 🔮 Best use of Pyth Entropy ⸺ $5,000 Up to 4 teams will receive $1,250 Use Pyth Entropy to generate and consume random number on chains. Anyone can permissionless generate random number on-chain. This pool prize will be given to most Innovative apps to use Pyth Entropy.
### Qualification Requirements
...
<a href="https://ethglob.al/xti9v">Pyth Entropy EVM guide https://docs.pyth.network/entropy/generate-random-numbers/evm ↗</a> <a href="https://ethglob.al/7sxyg">Pyth Entropy Examples https://github.com/pyth-network/pyth-examples/tree/main/entropy ↗</a> <a href="https://ethglob.al/hi813">Pyth Entropy Contract Address https://docs.pyth.network/entropy/contract-addresses ↗</a> <a href="https://ethglob.al/utwab">Pyth Entropy Best Practices https://docs.pyth.network/entropy/best-practices ↗</a>
### Resources

<a href="https://ethglob.al/b04z5">Pyth EVM guide https://docs.pyth.network/price-feeds/core/use-real-time-data/pull-integration/evm ↗</a> <a href="https://ethglob.al/k104c">Pyth Supported Price Feeds https://docs.pyth.network/price-feeds/core/price-feeds ↗</a> <a href="https://ethglob.al/wawc4">Pyth Supported Chains https://docs.pyth.network/price-feeds/core/contract-addresses/evm ↗</a> <a href="https://ethglob.al/0d5gk">Pyth EVM API Reference https://api-reference.pyth.network/price-feeds/evm/getPriceNoOlderThan ↗</a> <a href="https://ethglob.al/mab9p">How to Fetch Price Updates https://docs.pyth.network/price-feeds/core/fetch-price-updates ↗</a> <a href="https://ethglob.al/xozv2">EVM Error Codes https://docs.pyth.network/price-feeds/core/error-codes/evm ↗</a> <a href="https://ethglob.al/teu8b">Pyth Dev Forum https://dev-forum.pyth.network/ ↗</a> <a href="https://ethglob.al/p6her">Pyth's Hackathon Judging Criteria and Rubric - Price Feeds https://pyth-network.notion.site/Hackathon-Judging-Criteria-1fb2eecaaac980019603d905057e2f84 ↗</a> <a href="https://ethglob.al/8cc6c">Pyth's Hackathon Judging Criteria and Rubric - Entropy https://pyth-network.notion.site/Hackathon-Judging-Criteria-Entropy-2032eecaaac9808e9361cc6a7df2a649?pvs=73 ↗</a>
### Workshop

### 🛠️ Learn how to Pull Prices and consume Rand...

Pulling the Prices you deserve.

This workshop is happening in-person 06:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 3
...
[1inch.com](https://1inch.com/) [1inch](https://twitter.com/1inch) [Open page →](/events/buenosaires/prizes/1inch)
### About
...
💧 Build an Aqua App ⸺ $17,000 🥇 1st place $7,000 🥈 2nd place $4,000 🥉 3rd place $3,000 🏅 4th place $2,000 🏅 5th place $1,000 Create a custom Aqua app based on SwapVM that implements a sophisticated DeFi position. You may modify SwapVM opcodes and define your own instructions. The final positions must be demonstrated through tests, scripts or UI.
Examples:
- Leverage
- AMM
- Lending
...
<a href="https://ethglob.al/w6pss">1inch Hackathon Guide https://hackathon.1inch.community ↗</a> <a href="https://ethglob.al/8k1ou">The Art of AMM - Workshop by Anton Bukov [1inch] https://youtu.be/bdhba23BEzg?si=hPbmeWmA5RaYDRZB ↗</a> 💻 Utilize 1inch APIs ⸺ $3,000 Up to 3 teams will receive $1,000 Utilize 1inch's infrastructure to help build your application
...
<a href="https://ethglob.al/n0s3g">1inch Hackathon Guide https://hackathon.1inch.community ↗</a>
### Resources

<a href="https://ethglob.al/7neyf">1inch Hackathon Guide https://hackathon.1inch.community ↗</a>
### Workshop

### The Art of AMM

A deep-dive workshop into 1inch Aqua — the shared liquidity protocol set to transform DeFi. Anton shows how its op...

This workshop is happening in-person 06:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 1

### Jobs

<a href="/jobs/quality-assurance-engineer-fukxx">Quality Assurance Engineer 1inch →</a> <a href="/jobs/senior-frontend-engineer-angular-7tjbb">Senior Frontend Engineer [Angular] 1inch →</a> <a href="/jobs/blockchain-engineer-at-1inch-o6oxq">Blockchain Engineer at 1inch 1inch →</a>
...
[world.org](https://world.org/) [worldcoin](https://twitter.com/worldcoin) [Open page →](/events/buenosaires/prizes/world)
### About
...
📲 Best Mini App ⸺ $17,000 🥇 1st place $6,500 🥈 2nd place $4,500 🥉 3rd place $2,000 🏅 Honorable Mention $1,000 ×4 Show us your best Mini Apps! Projects that build and deploy a Mini App using MiniKit are eligible for this prize.
### Qualification Requirements
...
<a href="https://ethglob.al/yijqs">Mini App Documentation https://docs.world.org/mini-apps ↗</a> 🏊 World Pool Prize ⸺ $3,000 Split evenly between all qualifying projects This pool prize is for all projects that build within the World ecosystem (and don't receive another prize from World)!
### Qualification Requirements
...
<a href="https://ethglob.al/nhvhw">World Docs https://docs.world.org/ ↗</a>
### Resources

<a href="https://ethglob.al/upcp1">World ID Docs https://docs.world.org/world-id ↗</a> <a href="https://ethglob.al/xt6j0">World Chain Docs https://docs.world.org/world-chain ↗</a> <a href="https://ethglob.al/3db4x">Mini App Docs https://docs.world.org/mini-apps ↗</a> <a href="https://ethglob.al/78y6f">How to Build a Mini App https://www.youtube.com/watch?v=QJ0htHP6lb0 ↗</a>
### Workshop

### Mini Apps FTW

Learn how to build scalable and viral mini apps that solve real world use cases!

This workshop is happening in-person 05:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 1
...
[uniswapfoundation.org](https://www.uniswapfoundation.org/build) [uniswapfnd](https://twitter.com/UniswapFND) [Open page →](/events/buenosaires/prizes/uniswap-foundation)
### About
...
💡 Uniswap v4 Stable-Asset Hooks ⸺ $10,000 🥇 1st place $4,000 🥈 2nd place $2,000 ×2 🥉 3rd place $1,000 ×2 Build Uniswap v4 Hooks designed for stable-asset markets. Projects should explore novel applications of Hooks for synthetic lending, credit-backed trading, or optimized stable AMM logic.
### Qualification Requirements
...
<a href="https://ethglob.al/apczj">Uniswap Foundation Hacker Toolkit https://uniswap.notion.site/ethglobal-buenosaires ↗</a> 🪝 Uniswap v4 Volatile-Pairs Hooks ⸺ $10,000 🥇 1st place $4,000 🥈 2nd place $2,000 ×2 🥉 3rd place $1,000 ×2 Build Uniswap v4 Hooks designed for volatile asset pairs. Projects should explore innovative Hook logic that enhances liquidity resilience, mitigates Loss Versus Rebalancing (LVR), or improves capital efficiency for volatile asset pairs.
### Qualification Requirements
...
<a href="https://ethglob.al/o0ugd">Uniswap Foundation Hacker Toolkit https://uniswap.notion.site/ethglobal-buenosaires ↗</a>
### Resources

<a href="https://ethglob.al/b3fe0">Uniswap Documentation https://docs.uniswap.org/ ↗</a> <a href="https://ethglob.al/7gd3k">Uniswap v4 Started Kit https://github.com/uniswapfoundation/v4-template ↗</a> <a href="https://ethglob.al/vvi7b">Uniswap Foundation Builder Page https://www.uniswapfoundation.org/build ↗</a> <a href="https://ethglob.al/g580o">Open Zeppelin Hooks Library https://docs.openzeppelin.com/uniswap-hooks ↗</a>
...
[coinbase.com](https://coinbase.com/developer-platform) [coinbasedev](https://twitter.com/coinbasedev) [Open page →](/events/buenosaires/prizes/coinbase-developer-platform)
### About
...
💙 Build a Great Onchain App Using CDP ⸺ $20,000 Up to 4 teams will receive $5,000 We’re looking for high-quality onchain apps that use at least one of the following CDP tools:
...
<a href="https://ethglob.al/fqaqn">CDP Documentation https://docs.cdp.coinbase.com/ ↗</a>
### Workshop

### Building With x402: Agents, Paid APIs, & Embe...

A hands-on crash course on x402 and CDP Embedded Wallets. You'll learn how to spin up agents that pay with x402, cr...

This workshop is happening in-person 06:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 5

![Filecoin logo](https://ethglobal.b-cdn.net/organizations/bnkyu/square-logo/default.png)

## Filecoin

$20,000

[filecoin.io](https://filecoin.io/) [filecoin](https://twitter.com/Filecoin) [Open page →](/events/buenosaires/prizes/filecoin)
### About
...
💾 Best storage innovation with Filecoin Onchain Cloud ⸺ $10,000 🥇 1st place $5,000 🥈 2nd place $3,500 🥉 3rd place $1,500 For this price, we would love to see applications built around decentralized storage itself using Filecoin Onchain Cloud. 
...
👾 Best dApps powered by Filecoin Onchain Cloud ⸺ $10,000 🥇 1st place $5,000 🥈 2nd place $3,500 🥉 3rd place $1,500 For this price, we are looking for dApps built on any blockchain to leverage the Filecoin Onchain Cloud for decentralized storage needs.
...
<a href="https://ethglob.al/x6v0s">Filecoin Onchain Cloud https://www.filecoin.cloud/ ↗</a> <a href="https://ethglob.al/3ehpx">Synapse SDK https://github.com/FilOzone/synapse-sdk ↗</a> <a href="https://ethglob.al/7i35k">Filecon Pin docs https://docs.filecoin.io/builder-cookbook/filecoin-pin ↗</a> <a href="https://ethglob.al/rwu0z">Synapse SDK Demo https://github.com/FIL-Builders/fs-upload-dapp ↗</a> <a href="https://ethglob.al/6zre5">Filecoin Onchain Cloud Documentation https://docs.filecoin.cloud/ ↗</a>
### Workshop

### Filecoin 🛠️ Building with the Filecoin Oncha...

Roll up your sleeves for a hands-on dive into the Filecoin Onchain Cloud stack. You’ll explore the cryptographic fo...

This workshop is happening in-person 02:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 3

![EVVM logo](https://ethglobal.b-cdn.net/organizations/gatm1/square-logo/default.png)

## EVVM

$20,000

[evvm.org](https://www.evvm.org/) [rollamate](https://twitter.com/RollAMate) [Open page →](/events/buenosaires/prizes/evvm)
### About
...
⚡️ Best integration using the MATE Metaprotocol ⸺ $7,000 🥇 1st place $2,500 🥈 2nd place $1,500 🥉 3rd place $1,250 🏅 4th place $1,000 🏅 5th place $750 Connect your project with the MATE Metaprotocol (our official EVVM tesnet deployed on Sepolia) with a x402 agents OR make your dApp.
...
<a href="https://ethglob.al/r2ipv">EVVM Telegram Devs Group https://t.me/EVVMorg ↗</a> <a href="https://ethglob.al/jnece">$MATE Sepolia Faucet https://evvm.dev ↗</a> 🎣 Novel EVVM Fisher/Relayer ⸺ $5,000 🥇 1st place $2,500 🥈 2nd place $1,000 🥉 3rd place $750 🏅 4th place $500 🏅 5th place $250 Capture and/or Receive transactions and execute them in an EVVM. If you feel confident, try to do something legendary, something out of the box with fishing spots and fishers!
### Qualification Requirements
...
<a href="https://ethglob.al/2mw1u">EVVM Telegram Devs Group https://t.me/EVVMorg ↗</a> <a href="https://ethglob.al/97ira">$MATE Sepolia Faucet https://evvm.dev ↗</a> ⚙️ Your custom Service or EVVM Chain ⸺ $5,000 🥇 1st place $2,500 🥈 2nd place $1,000 🥉 3rd place $750 🏅 4th place $500 🏅 5th place $250 Create a new EVVM Service or a cusotmized EVVM that you believe is needed today. Check the Mate NameService, p2p Swap and Staking as references and/or starting point. We are looking forward to see more Services and customized chains related to -gasless- Retail, -async- DeFi, Governance, Institutions (Gov, Schools, Librares, etc) and Gaming.
### Qualification Requirements
...
<a href="https://ethglob.al/j16rt">EVVM Telegram Devs Group https://t.me/EVVMorg ↗</a> <a href="https://ethglob.al/a73f3">$MATE Sepolia Faucet https://evvm.dev ↗</a> ⭐️ Use the MATE Metaprotocol ⸺ $2,500 Split evenly between all qualifying projects Make your project interact in a meaningful way with the MATE Metaprotocol (our official EVVM tesnet and/or Servces deployed on Sepolia) or its ecosystem.
...
<a href="https://ethglob.al/ya504">EVVM Telegram Devs Group https://t.me/EVVMorg ↗</a> <a href="https://ethglob.al/r6f7d">$MATE Sepolia Faucet https://evvm.dev ↗</a> 📝 Feeback on EVVM or MATE Metaprotocol ⸺ $500 Up to 5 teams will receive $100 Give us a feedback, could be on the product, tooling, documentation, workshops or any other related to the EVVM, the MATE Metaaprotocol desgn, the vailable Services or recommendations for new ones!
### Qualification Requirements
...
<a href="https://ethglob.al/r1tke">EVVM Telegram Devs Group https://t.me/EVVMorg ↗</a>
### Resources

<a href="https://ethglob.al/zqn34">Tooling & Frontend Templates https://evvm.dev ↗</a> <a href="https://ethglob.al/uo950">Documentation https://evvm.info ↗</a> <a href="https://ethglob.al/25pc4">Website https://evvm.org ↗</a> <a href="https://ethglob.al/mfri3">QuickStart https://www.evvm.info/docs/QuickStart ↗</a> <a href="https://ethglob.al/o6dco">Workshop for Beginners https://www.youtube.com/watch?v=uBjvoH5tpJk ↗</a> <a href="https://ethglob.al/ufx57">Whats the EVVM? - ETHPragma Talk https://www.youtube.com/watch?v=7eJ4WEoi-_s ↗</a> <a href="https://ethglob.al/5ot71">Github Repo https://github.com/EVVM-org ↗</a>
### Workshop

### 🛠️ Virtual Blockchains in 60 Seconds: Expert...

Hands-on quickstart + tips for shipping virtual blockchains at hackathons, including the EVVM Full Documentation fo...

This workshop is happening in-person 05:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 2
...
[protocol.ai](https://www.protocol.ai/) [protocollabs](https://twitter.com/protocollabs) [Open page →](/events/buenosaires/prizes/protocol-labs)
### About
...
⚠️ Important:
Submitting on ETHGlobal is great.
Submitting on DevSpot is mandatory.
By doing so you’re competing not once but twice at a chance to win
👉 https://pl-genesis-frontiers-of-collaboration-hackathon.devspot.app
### Prizes

🌎 Secure, Sovereign Systems ⸺ $5,000 What we’re looking for:
...
<a href="https://ethglob.al/7y4gk">PL_Genesis Hackathon Submission https://pl-genesis-frontiers-of-collaboration-hackathon.devspot.app ↗</a> 🤖 AI & Autonomous Infrastructure ⸺ $5,000 What we’re looking for:
...
<a href="https://ethglob.al/b9c4j">PL_Genesis Hackathon Submission https://pl-genesis-frontiers-of-collaboration-hackathon.devspot.app ↗</a> 🧑‍🤝‍🧑 Decentralized Economies, Incentives & Governance ⸺ $5,000 What we’re looking for:
...
<a href="https://ethglob.al/dih9p">PL_Genesis Hackathon Submission https://pl-genesis-frontiers-of-collaboration-hackathon.devspot.app ↗</a> 📈 Open Data, Knowledge Graphs & Research Infra ⸺ $5,000 What we’re looking for:
...
<a href="https://ethglob.al/k00bv">PL_Genesis Hackathon Submission https://pl-genesis-frontiers-of-collaboration-hackathon.devspot.app ↗</a>
### Workshop

### Protocol Labs Challenges Q&A

Ask us Anything as about building the future. Informal session to get idea feedback and learn about what we're look...

This workshop is happening in-person 05:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 3
...
[chain.link](https://chain.link/) [chainlink](https://twitter.com/chainlink) [Open page →](/events/buenosaires/prizes/chainlink)
### About
...
🌎 Connect the World with Chainlink ⸺ $6,000 Up to 3 teams will receive $2,000 Build something awesome using Chainlink! Anything that came from the Chainlink Documentation counts - using CCIP, Price Feeds, Data Streams, PoR or VRF.
...
<a href="https://ethglob.al/jh12u">Chainlink Documentation http://docs.chain.link ↗</a> 🔗 Best workflow with Chainlink CRE ⸺ $9,000 Up to 3 teams will receive $3,000 Build your first workflow with CRE! Chainlink Runtime Environment (CRE) is an all-in-one orchestration layer that enables developers to build institutional-grade smart contracts — data-connected, compliance-ready, privacy-preserving, and interoperable across blockchains and traditional systems. With CRE, you can connect blockchains to external APIs, enterprise systems, data sources, LLMs, or AI agents. 
...
<a href="https://ethglob.al/powt2">CRE Documentation https://docs.chain.link/cre ↗</a>
### Workshop

### 🛠️ Build your first workflow with CRE

Build your first workflow with CRE! Chainlink Runtime Environment (CRE) is the all-in-one orchestration layer unloc...

This workshop is happening in-person 06:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 4
...
[chiliz.com](https://www.chiliz.com/developers/) [chiliz](https://twitter.com/Chiliz) [Open page →](/events/buenosaires/prizes/chiliz)
### About
...
🏈 The Future of Fan Ownership ⸺ $5,000 🥇 1st place $3,000 🥈 2nd place $2,000 Prize Track: Fan Ownership
...
⚡ SportsFi & Real-World Yield ⸺ $5,000 🥇 1st place $3,000 🥈 2nd place $2,000 Prize Track: Sports x DeFi
...
<a href="https://ethglob.al/nkao8">Chiliz Chain Docs https://docs.chiliz.com ↗</a> <a href="https://ethglob.al/48ijv">Faucet https://spicy-faucet.chiliz.com ↗</a> <a href="https://ethglob.al/3q98i">Telegram Group https://t.me/BuildOnChiliz ↗</a>
### Workshop

### Intro to Chiliz and the Chiliz Chain

Join us for a live introduction to Chiliz and the Chiliz Chain, the Web3 infrastructure built for sports and entert...

This workshop is happening in-person 04:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 3
...
[oasis.net](https://oasis.net/) [oasisprotocol](https://twitter.com/OasisProtocol) [Open page →](/events/buenosaires/prizes/oasis-protocol)
### About
...
🏆 Build with Oasis ⸺ $10,000 🥇 1st place $4,000 🥈 2nd place $3,000 🥉 3rd place $1,500 🏅 4th place $1,000 🏅 5th place $500 What to build: 
...
<a href="https://ethglob.al/vmxkg">Ideas to get started and judging criteria https://docs.google.com/document/d/1zVyAu3ivkZvTej5RSAUc5BkhHB0GFE-yG1Jh7DmQhdg/edit?tab=t.0 ↗</a>
### Resources

<a href="https://ethglob.al/ejewx">Oasis Cheatsheet https://drive.google.com/file/d/1Ab1mt-tYi5J72xcylB3OlwfpFGfd-NdU/view?usp=sharing ↗</a> <a href="https://ethglob.al/zshxf">ROFL Workshop https://drive.google.com/file/d/1eKWrWGKP_FQ4gFgH_4iSl_LH46ksvxuZ/view ↗</a> <a href="https://ethglob.al/2jqzz">Sapphire: Working with a confidential EVM https://www.youtube.com/watch?v=c_N8edT41-Q ↗</a> <a href="https://ethglob.al/283qz">Oasis Testnet Faucet https://faucet.testnet.oasis.io/ ↗</a> <a href="https://ethglob.al/9e786">Oasis ROFL https://docs.oasis.io/rofl/ ↗</a> <a href="https://ethglob.al/2855n">Oasis Sapphire Paratime (EVM Compatible) https://docs.oasis.io/dapp/sapphire/ ↗</a> <a href="https://ethglob.al/5b3fu">Oasis Social Media Channels https://docs.oasis.io/get-involved/ ↗</a> <a href="https://ethglob.al/bcbmb">Oasis Network Documentation https://docs.oasis.io/ ↗</a> <a href="https://ethglob.al/206uc">Demo Dapp: Telegram chatbot with integrated LLM https://github.com/oasisprotocol/demo-rofl-tgbot/tree/ollama ↗</a> <a href="https://ethglob.al/ujfv3">Demo Dapp: Price Oracle https://github.com/oasisprotocol/demo-rofl ↗</a> <a href="https://ethglob.al/x5k2g">Block Explorer for ROFLs https://explorer.oasis.io/testnet/sapphire/rofl/app ↗</a> <a href="https://ethglob.al/dgcp5">ROFLs from older hackathons https://playground.oasis.io/?tags=ROFL ↗</a>
### Workshop

### 🛠️ Build 8004 Agents with Oasis

The workshop will show you how to run your agent with Oasis' TEE infrastructure, register it to an 8004 registry, a...

This workshop is happening in-person 03:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 3
...
[zircuit.com](https://www.zircuit.com/) [zircuitl2](https://twitter.com/ZircuitL2) [Open page →](/events/buenosaires/prizes/zircuit)
### About
...
🏆 Best DeFi Project on Zircuit ⸺ $6,000 🥇 1st place $3,750 🥈 2nd place $2,250 Apply your hacking skills to generate the best APY or improve the user experience of DeFi for the masses on Zircuit. This prize will be split among the best DeFi protocols that deploy on Zircuit, with quality, security, and novelty being the deciding factors. Remember: deploying on Zircuit is as easy as changing your endpoint in your favorite development framework and a project is eligible as long as the contracts are deployed on Zircuit and verified.
...
<a href="https://ethglob.al/uj0vc">Deploy on Zircuit Quick Start https://docs.zircuit.com/build-on-zircuit/deploy-on-zircuit ↗</a> <a href="https://ethglob.al/xkhgk">Zircuit RPC Endpoints https://docs.zircuit.com/dev-tools/rpc-endpoints ↗</a> <a href="https://ethglob.al/cpj6w">Verifying Contracts on Zircuit https://docs.zircuit.com/dev-tools/verifying-contracts ↗</a> 🧩 Best use of Account Abstraction ⸺ $3,500 🥇 1st place $2,250 🥈 2nd place $1,250 Zircuit supports EIP-7702 which brings some account abstraction on-chain. This bounty is to use this functionality in a new and complete way on-chain. This can include deploying contracts to delegate to, interfaces to use the new transaction types, and more. Remember: deploying on Zircuit is as easy as changing your endpoint in your favorite development framework. You may need to use command line tools to use 7702 functionality (see the links!).
...
<a href="https://ethglob.al/bbyo8">Deploy on Zircuit Quick Start https://docs.zircuit.com/build-on-zircuit/deploy-on-zircuit ↗</a> <a href="https://ethglob.al/6g637">Zircuit RPC Endpoints https://docs.zircuit.com/dev-tools/rpc-endpoints ↗</a> <a href="https://ethglob.al/h5exg">Verifying Contracts on Zircuit https://docs.zircuit.com/dev-tools/verifying-contracts ↗</a> <a href="https://ethglob.al/0er7t">List of Sepolia Faucets https://docs.zircuit.com/dev-tools/faucet ↗</a> <a href="https://ethglob.al/sc6xr">EIP-7702 https://github.com/ethereum/EIPs/blob/master/EIPS/eip-7702.md ↗</a> <a href="https://ethglob.al/zat5s">How to Test EIP-7702 Features with Foundry https://www.quicknode.com/guides/ethereum-development/smart-contracts/eip-7702-smart-accounts ↗</a> 🌟 Best Zircuit Integration ⸺ $500 Integrate Zircuit into your favorite web3 project. Bring Zircuit to wallets, dev tools, bridges, or any other dApp. Grow the Zircuit Ecosystem by connecting Zircuit to the best that web3 has to offer.
...
<a href="https://ethglob.al/cy646">Deploy on Zircuit Quick Start https://docs.zircuit.com/build-on-zircuit/deploy-on-zircuit ↗</a> <a href="https://ethglob.al/2p1z0">Zircuit RPC Endpoints https://docs.zircuit.com/dev-tools/rpc-endpoints ↗</a> <a href="https://ethglob.al/y8yqr">Verifying Contracts on Zircuit https://docs.zircuit.com/dev-tools/verifying-contracts ↗</a> <a href="https://ethglob.al/88v2a">List of Sepolia Faucets https://docs.zircuit.com/dev-tools/faucet ↗</a>
### Resources

<a href="https://ethglob.al/k6t63">Learn more https://www.zircuit.com ↗</a> <a href="https://ethglob.al/1pzya">Follow us on X https://x.com/ZircuitL2 ↗</a>
### Workshop

### 🛠️ Building on Zircuit: A Hackathon Introduc...

This workshop will give you an introduction to winning prizes using Zircuit. We’ll cover what we think makes a top ...

This workshop is happening in-person 05:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 5

### Jobs

<a href="/jobs/blockchain-developer-mxfo2">Blockchain Developer Zircuit →</a> <a href="/jobs/senior-rust-engineer-zsg8f">Senior Rust Engineer Zircuit →</a>
...
[nethermind.io](https://www.nethermind.io/) [nethermind](https://twitter.com/Nethermind) [Open page →](/events/buenosaires/prizes/nethermind)
### About
...
🏆 AuditAgent: Find, Fix, and Fortify ⸺ $500 Smart contract security remains one of the toughest challenges in Web3 — and the gap is widening. As AI accelerates code generation and vibe coding pushes unaudited contracts to the Ethereum mainnet, vulnerabilities are slipping through faster than review processes or traditional audits can catch them.
...
<a href="https://ethglob.al/t2c5k">AuditAgent https://auditagent.nethermind.io/ ↗</a> <a href="https://ethglob.al/qgerx">AuditAgent Documentation https://docs.auditagent.nethermind.io/ ↗</a> 🏆 The Agentic Frontier: Coordination Without Permission ⸺ $2,500 Ethereum is not just a blockchain; it is the most open coordination protocol ever built. It enables anyone, whether human or machine, to participate in shared rules, value exchange, and governance without requiring permission.
...
<a href="https://ethglob.al/yga6e">Agent Framework Eliza (JS/TS) https://github.com/elizaOS/eliza ↗</a> <a href="https://ethglob.al/fvm46">Agent Framework ZerePy https://github.com/blorm-network/ZerePy ↗</a> <a href="https://ethglob.al/6pdwo">Agent Framework LangGraph https://www.langchain.com/langgraph ↗</a> <a href="https://ethglob.al/t14kq">Agent Framework Crew AI https://www.crewai.com/ ↗</a> <a href="https://ethglob.al/qgkjs">Agent Framework AutoGen https://github.com/microsoft/autogen ↗</a> <a href="https://ethglob.al/8dtx0">Ethereum Development https://ethereum.org/developers/ ↗</a> <a href="https://ethglob.al/aab8a">ERC-8004 https://eips.ethereum.org/EIPS/eip-8004 ↗</a> <a href="https://ethglob.al/fuz15">ChaosChain SDK https://pypi.org/project/chaoschain-sdk/ ↗</a> <a href="https://ethglob.al/wpwf6">ChaosChain SDK https://www.npmjs.com/package/@chaoschain/sdk ↗</a> 🏆 AgentArena: Build the Next Generation of Security Agents ⸺ $3,000 AI is transforming the battlefield of smart contract security. As vibe coding accelerates and more unaudited protocols rush to deployment, vulnerabilities are slipping through human review processes. At the same time, AI-driven attackers are getting faster, smarter, and more adaptive; therefore, the defenders must evolve too.
...
<a href="https://ethglob.al/weqsy">Agent Template https://github.com/NethermindEth/agentarena-agent-template ↗</a> <a href="https://ethglob.al/g0wx3">Documentation https://nethermindeth.github.io/agentarena-docs/docs/builder-guide ↗</a> 🏆 Building Verifiable Agents with the Triple-Verified Stack ⸺ $4,000 🥇 1st place $2,500 🥈 2nd place $1,500 The age of autonomous agents is here, but it runs on a massive trust deficit. How do you prove an AI agent did what it was supposed to do, and nothing more?
...
<a href="https://ethglob.al/vgchd">Genesis Studio https://github.com/ChaosChain/chaoschain-genesis-studio ↗</a> <a href="https://ethglob.al/6bh4w">ChaosChain https://x.com/_sumeetc/status/1969678477205840137 ↗</a> <a href="https://ethglob.al/jta41">Managed Facilitator https://facilitator.chaoscha.in/ ↗</a> <a href="https://ethglob.al/gov0a">TypeScript SDK https://github.com/ChaosChain/chaoschain-sdk-ts ↗</a> <a href="https://ethglob.al/k6325">Python SDK https://github.com/ChaosChain/chaoschain/tree/main/packages/sdk ↗</a> <a href="https://ethglob.al/brf65">ChaosChain x402 repo (facilitator & paywall) https://github.com/ChaosChain/chaoschain-x402 ↗</a>
### Workshop
...
This workshop is happening in-person 03:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 3

### Jobs

<a href="/jobs/senior-engineer-advanced-problem-solver-880in">Senior Engineer - Advanced Problem Solver Nethermind →</a> <a href="/jobs/account-executive-web3-security-solutions-68mo2">Account Executive - Web3 Security Solutions Nethermind →</a>
...
[dev.flare.network](https://dev.flare.network/) [flarenetworks](https://twitter.com/FlareNetworks) [Open page →](/events/buenosaires/prizes/flare-network)
### About
...
🏆 MAIN TRACK: use protocols on Flare blockchain ⸺ $8,000 🥇 1st place $5,000 🥈 2nd place $2,000 🥉 3rd place $1,000 Use protocols on Flare blockchain in an innovative and world changing way!
...
<a href="https://ethglob.al/kmaut">Flare Time Series Oracle (FTSO) https://dev.flare.network/ftso/overview ↗</a> <a href="https://ethglob.al/ztck7">Flare Data Connector (FDC) https://dev.flare.network/fdc/overview ↗</a> <a href="https://ethglob.al/b0ykb">Flare Secure Random Guide https://dev.flare.network/network/guides/secure-random-numbers ↗</a> <a href="https://ethglob.al/0wv0b">FAssets https://dev.flare.network/fassets/overview ↗</a> 🎨 BONUS TRACK: external data source or cross chain application ⸺ $2,000 Up to 2 teams will receive $1,000 Most innovative external data source use case or most innovative cross chain application secured by Flare’s protocols.
### Qualification Requirements
...
<a href="https://ethglob.al/hz6tj">Flare Data Connector (FDC) https://dev.flare.network/fdc/overview ↗</a>
### Resources

<a href="https://ethglob.al/kuu6q">Flare Developer Hub https://dev.flare.network/ ↗</a> <a href="https://ethglob.al/5dfm5">Flare Time Series Oracle (FTSO) https://dev.flare.network/ftso/overview ↗</a> <a href="https://ethglob.al/ravqa">Flare Data Connector (FDC) https://dev.flare.network/fdc/overview ↗</a> <a href="https://ethglob.al/j0uqe">Flare Secure Random Guide https://dev.flare.network/network/guides/secure-random-numbers ↗</a> <a href="https://ethglob.al/hsnqw">XRP to DeFi (FAssets) https://dev.flare.network/fassets/overview ↗</a> <a href="https://ethglob.al/d829g">Quickstart notion https://www.notion.so/flare-network/Flare-Hackathon-Guide-ETHGlobal-New-York-22bd502e6fa6802a9bdbd4afa9d8bef0?source=copy_link ↗</a>
### Workshop

### 🛠️ Flare Data Protocols and Smart Accounts

In this workshop, we'll explore what makes Flare truly unique through our data protocols and the products that can...

This workshop is happening in-person 03:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 2
...
[hedera.com](https://hedera.com/) [hedera](https://twitter.com/hedera) [Open page →](/events/buenosaires/prizes/hedera)
### About
...
🤖 Best Use of Hedera Agent Kit & Google A2A ⸺ $4,000 Create one or more agents using the Hedera Agent Kit that can send and receive A2A messages and, if appropriate, settle payments via AP2 using Hedera tokens. For example, an AI travel agent might negotiate bookings with other agents and pay with stablecoins.
### Qualification Requirements
...
<a href="https://ethglob.al/udehv">Getting Started https://hedera.com/getting-started ↗</a> <a href="https://ethglob.al/rjkhk">A2A Protocol https://github.com/a2aproject/A2A ↗</a> <a href="https://ethglob.al/p30cc">Hedera Developer Playground https://portal.hedera.com/playground ↗</a> <a href="https://ethglob.al/0xf98">Hedera Agent Kit https://docs.hedera.com/hedera/open-source-solutions/ai-studio-on-hedera/hedera-ai-agent-kit ↗</a> 🔌 Best Plug-In for Hedera Agent Kit ⸺ $2,000 Up to 2 teams will receive $1,000 The Hedera Agent Kit supports a plugin architecture that allows developers to add new tools and integrate third‑party services. This bounty rewards the most useful and well‑architected new plugin that introduces new capabilities. Plugins might wrap external APIs (e.g., DeFi protocols, data providers), simplify token operations, or provide analytics and monitoring.
### Qualification Requirements
...
<a href="https://ethglob.al/sdfhq">Hedera AI Agent Kit Quickstart https://docs.hedera.com/hedera/open-source-solutions/ai-studio-on-hedera/hedera-ai-agent-kit ↗</a> <a href="https://ethglob.al/dnox1">How to Create a Plugin https://github.com/hashgraph/hedera-agent-kit-js/blob/main/docs/PLUGINS.md ↗</a> <a href="https://ethglob.al/qd8o3">Create Hedera Agent Kit NextJS App https://www.npmjs.com/package/create-hedera-agent ↗</a> 🔗 EVM Innovator Track ⸺ $4,000 Hedera’s EVM compatibility allows developers to write Solidity contracts while benefiting from fast finality and low fees. This bounty is about using cross‑chain and real‑world data to build innovative dApps. Example ideas include multi‑chain financing, cross‑chain auctions or data‑driven trading bots.
### Qualification Requirements
...
<a href="https://ethglob.al/18zw2">Getting Started on Hedera EVM https://docs.hedera.com/hedera/getting-started-evm-developers ↗</a> <a href="https://ethglob.al/p1eom">Oracles on Hedera https://docs.hedera.com/hedera/open-source-solutions/oracle-networks ↗</a> <a href="https://ethglob.al/crfug">Contract Verification on Hashscan https://docs.hedera.com/hedera/tutorials/smart-contracts/how-to-verify-a-smart-contract-on-hashscan ↗</a> <a href="https://ethglob.al/6ibcr">Hedera Portal Contract Builder https://docs.hedera.com/hedera/tutorials/smart-contracts ↗</a> <a href="https://ethglob.al/8fm12">Bridges on Hedera https://docs.hedera.com/hedera/open-source-solutions/interoperability-and-bridging ↗</a>
### Resources

<a href="https://ethglob.al/wu48z">Hedera Docs https://docs.hedera.com ↗</a> <a href="https://ethglob.al/spyxb">Hedera Contract Builder (Remix IDE) https://portal.hedera.com/contract-builder ↗</a> <a href="https://ethglob.al/10qfe">Hedera SDK Playground https://portal.hedera.com/playground ↗</a> <a href="https://ethglob.al/rtmww">Hedera Hivemind GPT https://chatgpt.com/g/g-TuVHDmAdq-hedera-hivemind ↗</a>
...
[ledger.com](https://ledger.com/) [ledger](https://twitter.com/Ledger) [Open page →](/events/buenosaires/prizes/ledger)
### About
...
📝 CLEAR SIGNING (ERC-7730) ⸺ $4,000 🥇 1st place $2,500 🥈 2nd place $1,500 Enable human-readable signing for any dApp. Author ERC-7730 descriptors to decode complex transactions, or build the developer tooling needed to scale the standard.
Example projects:
- Create ERC-7730 JSON files for DeFi protocols → Win a Ledger device
- Build tooling for ERC-7730 creation/validation
- Improve the JSON Creation Tool 🛠️ [L] HARDWARE INTEGRATIONS ⸺ $5,000 🥇 1st place $3,000 🥈 2nd place $2,000 Expand Ledger hardware support with the Device Management Kit. Add signers, upstream improvements, or build Discover Live Apps.
Example projects:
...
- Build a Device App (C/Rust) or a Discover Live App ✨ CREATIVITY AWARD ⸺ $1,000 Rewarding surprising, high-impact ideas that change how people build with Ledger.
### Qualification Requirements
...
### 🛠️ Ledger Direct Connectivity for dApps

Come and experiment the new way of integrating a direct connection with Ledger Hardware Signers.

This workshop is happening in-person 03:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 4

### Jobs

<a href="/jobs/software-engineer-backend-scala-rxvd9">Software Engineer - Backend Scala Ledger →</a>
...
[availproject.org](https://www.availproject.org/) [availproject](https://twitter.com/availproject) [Open page →](/events/buenosaires/prizes/avail)
### About
...
🌊 Build Unchained Apps with Avail Nexus SDK (General Track) ⸺ $4,500 🥇 1st place $2,500 🥈 2nd place $2,000 For this track, devs are free to build anything, any dapp or usecase powered by Avail Nexus.
...
📝 Developer Feedback (Test our Docs) ⸺ $500 Test out the Avail Nexus SDK in your projects. Give us with any feedback as you try to build with it. If you feel like something is missing or hard to find on the docs, let us know! Add images, videos, anything to get the point across.
Add your feedback to AVAIL_FEEDBACK.md in your submission repo.
### Qualification Requirements
...
<a href="https://ethglob.al/yn9i3">Project Ideas [CHECK THIS OUT] https://avail-project.notion.site/ETHOnline-Avail-Nexus-Project-Ideas-289e67c666dd8009961effac6466f6b9?pvs=74 ↗</a> <a href="https://ethglob.al/g874i">Avail Nexus Docs https://docs.availproject.org/nexus/introduction-to-nexus ↗</a> <a href="https://ethglob.al/ak0h1">Nexus Cheatsheet https://docs.availproject.org/nexus/nexus-cheatsheet ↗</a> <a href="https://ethglob.al/piziu">Nexus NextJS Starter Template https://github.com/availproject/nexus-nextjs-template ↗</a> <a href="https://ethglob.al/2a3zp">Nexus Vite Starter Template https://github.com/availproject/nexus-vite-template ↗</a> <a href="https://ethglob.al/141kw">Shadcn UI Elements - Nexus https://elements.nexus.availproject.org/ ↗</a>
### Workshop

### Avail Workshop

Avail is designed for a new era where users, dApps, and tokens can navigate the onchain economy at an unprecedented...

This workshop is happening in-person 05:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 1
...
[polygon.technology](https://polygon.technology/) [0xpolygon](https://twitter.com/0xPolygon) [Open page →](/events/buenosaires/prizes/polygon)
### About
...
💸 Best Use of Agentic Payments on Polygon ⸺ $10,000 🥇 1st place $3,500 🥈 2nd place $2,500 🥉 3rd place $2,000 🏅 4th place $1,250 🏅 5th place $750 We want to see projects building innovative payment projects using x402 and agentic tooling developed by Polygon deployed to the Polygon network.
We're looking for two kinds of projects:
...
<a href="https://ethglob.al/1wpbb">Polygon Agentic Payments Documentation https://agentic-docs.polygon.technology ↗</a> <a href="https://ethglob.al/0tohg">AutoPay Extension for x402 https://agentic-docs.polygon.technology/general/x402/autopay/ ↗</a> <a href="https://ethglob.al/4sj91">LLM Wallet MCP library https://agentic-docs.polygon.technology/general/agentic/llm-wallet/intro/ ↗</a>
### Workshop

### Giving your LLMs their own crypto wallets

How can you give your LLM its own crypto wallet? And why would you? In an age of APIs gated with x402 micropayments...

This workshop is happening in-person 02:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 2
...
[circle.com](https://circle.com/) [circle](https://twitter.com/circle) [Open page →](/events/buenosaires/prizes/circle)
### About
...
🏆 Best Smart Contracts on Arc with Advanced Stablecoin Logic ⸺ $4,000 🥇 1st place $2,500 🥈 2nd place $1,500 Deploy smart contracts on Arc that demonstrate programmable logic using USDC or EURC.
...
<a href="https://ethglob.al/08f5o">Arc docs https://docs.arc.network/arc/concepts/welcome-to-arc ↗</a> <a href="https://ethglob.al/o9253">Testnet faucet https://faucet.circle.com ↗</a> 🏆 Best Crosschain USDC Experience with Circle's Bridge Kit and Arc ⸺ $2,000 Create a seamless crosschain app that leverages Circle's Bridge Kit to enable USDC transfers between Arc and supported chains.
### Qualification Requirements
...
<a href="https://ethglob.al/gp1bg">Bridge Kit docs https://developers.circle.com/bridge-kit ↗</a> 🏆 Best Automated Treasury Operations with Circle Gateway and Arc ⸺ $2,000 Build an onchain treasury automation system using Circle Gateway and Arc that manages, allocates, and distributes USDC. Bonus points for integrations that use Circle Wallets
### Qualification Requirements
...
<a href="https://ethglob.al/6kmds">Gateway docs https://developers.circle.com/gateway ↗</a> 🏆 Best AI Agent Wallet with Circle Wallets ⸺ $2,000 Create an autonomous agent that uses Circle Wallets to execute transactions on Arc. The agent should make decisions on real-world data or API inputs and transfer USDC.  Bonus points for integrating x402 to monetize API or AI-driven actions.
### Qualification Requirements
...
<a href="https://ethglob.al/qn26u">Circle Wallets docs https://developers.circle.com/w3s/programmable-wallets ↗</a> <a href="https://ethglob.al/6w9wh">Blog -Autonomous Payments using Circle Wallets, USDC, and x402 https://www.circle.com/blog/autonomous-payments-using-circle-wallets-usdc-and-x402 ↗</a> <a href="https://ethglob.al/sui72">Thirdweb on Arc https://thirdweb.com/arc-testnet?ref=blog.thirdweb.com ↗</a>
### Resources

<a href="https://ethglob.al/kt12f">Arc docs https://docs.arc.network/arc/concepts/welcome-to-arc ↗</a> <a href="https://ethglob.al/tsb1d">Circle Platform docs https://developers.circle.com/ ↗</a> <a href="https://ethglob.al/srxz2">Testnet faucet https://faucet.circle.com/ ↗</a> <a href="https://ethglob.al/s3q9d">Arc Discord https://discord.com/invite/buildonarc ↗</a>
### Workshop

<a href="https://www.youtube.com/watch?v=93eMzBT3gtA"></a> [Watch Video →](https://www.youtube.com/watch?v=93eMzBT3gtA)
### 🛠️Circle Workshop

Building with Arc and the Circle Developer Platform

This workshop is happening in-person 04:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 4
...
[ens.domains](https://ens.domains/) [ensdomains](https://twitter.com/ensdomains) [Open page →](/events/buenosaires/prizes/ens)
### About
...
🏅 Most creative use of ENS ⸺ $10,000 🥇 1st place $3,500 🥈 2nd place $2,000 🥉 3rd place $1,500 ×3 Any type of ENS integration is eligible for this prize. Get creative!
...
<a href="https://ethglob.al/z3z9s">ENS Developer Docs https://docs.ens.domains/ ↗</a>
### Workshop

### 🛠️ ENS - Identity in Your Apps

Learn all about ENS (Ethereum Name Service), the decentralised naming protocol used by hundreds of web2 and web3 ap...

This workshop is happening in-person 05:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 4
...
[fluence.network](https://fluence.network/) [fluence_project](https://twitter.com/fluence_project) [Open page →](/events/buenosaires/prizes/fluence)
### About
...
🤖 Best use of Fluence GPU containers API ⸺ $6,000 Up to 3 teams will receive $2,000 Build the most impactful application using Fluence GPU containers API on decentralized infrastructure.
🎯 Objective
Create a production-ready AI application leveraging Fluence GPU containers API that demonstrates real-world advantages of decentralized GPU compute—whether through cost efficiency, scalability, or improved accessibility.
🚀 Examples
Quantized LLM inference • Multi-model AI systems • Autonomous agents • Real-time data pipelines
### Qualification Requirements

🪼 To qualify, your project must integrate Fluence Cloudless Compute:
• Host your backend or core logic on Fluence CPU Cloud.
• Leverage the Fluence GPU Containers API to power your compute-intensive workloads (e.g., ML inference, rendering, etc.).
...
<a href="https://ethglob.al/neeye">Fluence Concole https://console.fluence.network/auth/sign-in ↗</a> <a href="https://ethglob.al/jrn4y">Main Docs https://fluence.dev/docs/build/overview ↗</a> <a href="https://ethglob.al/5yp35">API Wrapper https://github.com/boneyard93501/api-wrapper ↗</a> <a href="https://ethglob.al/nqyc9">How to Deploy on Fluence CPU https://www.fluence.network/blog/deploy-on-fluence-virtual-servers/ ↗</a> 🪼 Best use of Fluence CPU Cloud API ⸺ $4,000 Up to 2 teams will receive $2,000 Build the most impactful application using Fluence CPU cloud API on decentralized infrastructure.
🎯  Objective
...
<a href="https://ethglob.al/wf4yq">How to Deploy on Fluence CPU https://www.fluence.network/blog/deploy-on-fluence-virtual-servers/ ↗</a> <a href="https://ethglob.al/309do">Fluence Console https://console.fluence.network/auth/sign-in ↗</a> <a href="https://ethglob.al/296k3">Main Docs https://fluence.dev/docs/build/overview ↗</a> <a href="https://ethglob.al/1ggym">API Wrapper https://github.com/boneyard93501/api-wrapper ↗</a>
### Workshop

### 🛠️  How to Deploy on Fluence Cloudless Compu...

Learn how to deploy on Fluence - decentralized compute that's 75% cheaper than AWS with no vendor lock-in. Covers t...

This workshop is happening in-person 02:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 4

### Jobs

<a href="/jobs/business-development-manager-bzx90">Business Development Manager Fluence →</a> <a href="/jobs/devops-lead-qc69i">DevOps Lead Fluence →</a>
...
[saga.xyz](https://saga.xyz/) [sagaxyz__](https://twitter.com/Sagaxyz__) [Open page →](/events/buenosaires/prizes/saga)
### About
...
<a href="https://ethglob.al/07u2q">Buidler Guide for ETHGlobal Buenos Aires 2025 https://pepper-cupboard-57e.notion.site/Buidler-Guide-for-ETHGlobal-Buenos-Aires-2025-2a41fb5d290980adb493c03b5ba4e384 ↗</a>
### Resources

<a href="https://ethglob.al/gc2db">Buidler Guide for ETHGlobal Buenos Aires 2025 https://pepper-cupboard-57e.notion.site/Buidler-Guide-for-ETHGlobal-Buenos-Aires-2025-2a41fb5d290980adb493c03b5ba4e384 ↗</a> <a href="https://ethglob.al/syrjx">Launching your Layer 1 EVM chain for free https://medium.com/sagaxyz/launch-your-first-saga-chainlet-99541cc35ffa ↗</a> <a href="https://ethglob.al/dxato">Saga Developer Docs https://docs.saga.xyz/sagacli/quickstart-guide ↗</a>
### Workshop

### 🛠️ Launch your gasless EVM Blockchain in min...

This hands-on workshop is for developers tired of shared blockspace and unpredictable gas fees. We will guide you s...

This workshop is happening in-person 04:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 1

### Jobs

<a href="/jobs/senior-frontend-developer-hbvpe">Senior Frontend Developer Saga →</a> <a href="/jobs/senior-protocol-engineer-e36es">Senior Protocol Engineer Saga →</a>
...
[yellow.org](https://yellow.org/) [yellow](https://twitter.com/Yellow) [Open page →](/events/buenosaires/prizes/yellow)
### About
...
💎 Yellow Prize Pool ⸺ $10,000 🥇 1st place $5,000 🥈 2nd place $3,000 🥉 3rd place $2,000 Yellow is here to challenge you: explore the capabilities of ERC-7824 and the Nitrolite Protocol, whether by contributing to or building with the Yellow SDK.
### Qualification Requirements
...
<a href="https://ethglob.al/norae">Yellow SDK community https://t.me/YellowSDKCommunity ↗</a> <a href="https://ethglob.al/081nh">Documentation https://erc7824.org/ ↗</a> <a href="https://ethglob.al/oh442">How to build with Yellow SDK https://www.youtube.com/watch?v=dF0SeIYbyJY ↗</a>
### Workshop

### 🛠️ Yellow Network-High Performance Apps with...

Whether you're gearing up for the hackathon or exploring powerful new tools in Web3, this session breaks down how t...

This workshop is happening in-person 03:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 5
...
[hyperlane.xyz](https://www.hyperlane.xyz/) [hyperlane](https://twitter.com/hyperlane) [Open page →](/events/buenosaires/prizes/hyperlane)
### About
...
Join Eda and learn what you can build with Hyperlane, as well as get an overview of the bounties and project exampl...

This workshop is happening in-person 04:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 4
...
[hardhat.org](https://hardhat.org/) [hardhathq](https://twitter.com/HardhatHQ) [Open page →](/events/buenosaires/prizes/hardhat)
### About
...
👷 Best projects built using Hardhat 3 ⸺ $10,000 Up to 2 teams will receive $5,000 Build your project using Hardhat 3 as the main Solidity testing and network simulation tool
### Qualification Requirements
...
<a href="https://ethglob.al/gki0u">Hardhat docs https://hardhat.org/docs/getting-started ↗</a>
### Jobs

<a href="/jobs/senior-software-engineer-runtime-zz8m9">Senior Software Engineer - Runtime Hardhat →</a> <a href="/jobs/senior-developer-relations-advocate-j377m">Senior Developer Relations Advocate Hardhat →</a>
...
[celo.org](https://www.celo.org/) [celo](https://twitter.com/Celo) [Open page →](/events/buenosaires/prizes/celo)
### About
...
🏆 Best MiniApp on Celo ⸺ $10,000 🥇 1st place $6,000 🥈 2nd place $2,500 🥉 3rd place $1,500 We're looking for the next viral Mini App on Celo! 
...
<a href="https://ethglob.al/6041y">Build a Mini App with Celo Composer https://github.com/orgs/celo-org/discussions/26 ↗</a> <a href="https://ethglob.al/c724x">Farcaster Wallet Connect https://miniapps.farcaster.xyz/docs/guides/wallets ↗</a>
### Resources

<a href="https://ethglob.al/pfyk4">Website https://celo.org/ ↗</a> <a href="https://ethglob.al/xcpcv">Docs https://docs.celo.org/home/celo ↗</a> <a href="https://ethglob.al/mbw38">StarterKit https://github.com/celo-org/celo-composer ↗</a> <a href="https://ethglob.al/ry9w6">Faucet https://faucet.celo.org/celo-sepolia ↗</a> <a href="https://ethglob.al/hv51k">Project Ideas https://github.com/orgs/celo-org/discussions/categories/project-ideas ↗</a> <a href="https://ethglob.al/ofzni">ETH Global Partner List on Celo https://docs.google.com/document/d/1kdLWlv-WWoVRYAaohTA8QoMdhIRfhPTrTcPq2LxYWMI/edit?usp=sharing ↗</a>
...
[citrea.xyz](https://citrea.xyz/) [citrea_xyz](https://twitter.com/citrea_xyz) [Open page →](/events/buenosaires/prizes/citrea)
### About
...
🐸 Best Degen Bapps (Bitcoin Applications) ⸺ $6,000 🥇 1st place $4,000 🥈 2nd place $2,000 Citrea opens the door to an entirely new class of Bitcoin powered experiments. Some brilliant, some chaotic, some beautifully unhinged. The Best Degen Bapp track is for the builders who think outside the box, break assumptions, push boundaries, and ship the kind of ideas that make people say:
...
<a href="https://ethglob.al/hqb83">Hackathon Survival Guide: Citrea 101 https://www.notion.so/citrea/EthGlobal-New-Delhi-Citrea-Hacker-Survival-Guide-279c176f7c8080e59cd6cfdf19dbd242 ↗</a> <a href="https://ethglob.al/y8dpp">Developer Documentation https://docs.citrea.xyz ↗</a> <a href="https://ethglob.al/eymqp">Ecosystem Tooling https://docs.citrea.xyz/developer-documentation/ecosystem-tooling ↗</a> <a href="https://ethglob.al/mp1dk">Citrea Devs @BA https://t.me/citreadevsba ↗</a> 🍊 All-In Bitcoin ⸺ $4,000 🥇 1st place $2,500 🥈 2nd place $1,500 This track is for teams who want to work on ideas that strengthen Bitcoin’s role in the world: sound money, global access, resilience, interoperability, and long-term utility.
...
<a href="https://ethglob.al/ud1rr">Documentation https://docs.citrea.xyz ↗</a> <a href="https://ethglob.al/ynig4">Ecosystem Tooling https://docs.citrea.xyz/developer-documentation/ecosystem-tooling ↗</a> <a href="https://ethglob.al/p0yyg">Chain Information https://docs.citrea.xyz/welcome/chain-information ↗</a> <a href="https://ethglob.al/86obi">Website https://citrea.xyz ↗</a>
### Resources

<a href="https://ethglob.al/hc8f8">Developer Documentation https://docs.citrea.xyz ↗</a> <a href="https://ethglob.al/b66ca">Ecosystem Tooling https://docs.citrea.xyz/developer-documentation/ecosystem-tooling ↗</a> <a href="https://ethglob.al/jtarx">Website https://citrea.xyz ↗</a> <a href="https://ethglob.al/3omtn">Hackathon Survival Guide: Citrea 101 https://www.notion.so/citrea/EthGlobal-New-Delhi-Citrea-Hacker-Survival-Guide-279c176f7c8080e59cd6cfdf19dbd242 ↗</a> <a href="https://ethglob.al/myc0w">Citrea Devs @BA https://t.me/citreadevsba ↗</a>
### Workshop

### 🍊 A Guide to Building Bitcoin Applications o...

Citrea is the first ZK Rollup on Bitcoin with EVM compatibility, featuring a trust-minimized bridge called Clementi...

This workshop is happening in-person 04:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 3
...
[thegraph.com](https://thegraph.com/) [graphprotocol](https://twitter.com/graphprotocol) [Open page →](/events/buenosaires/prizes/the-graph)
### About
...
🔊 Best Use of Amp Datasets ⸺ $6,000 🥇 1st place $3,000 🥈 2nd place $2,000 🥉 3rd place $1,000 Rewarding the most compelling end-to-end product built on Amp datasets. 
Example Use Cases:
...
🤖 Best Use of The Graph for AI Use Cases ⸺ $2,000 Connect The Graph’s products in AI or autonomous agent workflows, including Token API MCP, Subgraph MCP, or Substreams to train AI models.
Example Use Cases:
...
<a href="https://ethglob.al/boq7e">Hackathon Resources https://thegraph.com/blog/hackathon-resources/ ↗</a> ✨ Best Use of Subgraph Advanced Features ⸺ $2,000 Innovative use of two or more advanced Subgraph features (i.e. Subgraph Dev Mode, Composition, Aggregations, or Declarative eth_calls).
Example Use Cases:
- Real-time DeFi analytics Subgraph combining Aggregations + `eth_calls` to show onchain metrics like APR or TVL.
- Composable Subgraph suite that merges multiple community Subgraphs for the same chain (DEXs, lending, governance) into a unified API.
- Developer toolkit or Subgraph simulator that leverages Dev Mode to accelerate Subgraph iteration and testing during the hackathon.
### Qualification Requirements

Projects should highlight faster development cycles, modular data design, and advanced querying powered by Subgraphs on The Graph Network using these new features.

### Links and Resources

<a href="https://ethglob.al/w36t3">Hackathon Resources https://thegraph.com/blog/hackathon-resources/ ↗</a>
### Workshop

### 🛠️ Amp: Enterprise-Grade Blockchain Data tha...

Edge & Node is introducing Amp, our next-generation infrastructure that turns blockchain data into an easily querya...

This workshop is happening in-person 04:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 5

![Symbiotic logo](https://ethglobal.b-cdn.net/organizations/y3oj0/square-logo/default.png)

## Symbiotic

$10,000

[symbiotic.fi](https://symbiotic.fi/) [symbioticfi](https://twitter.com/SymbioticFi) [Open page →](/events/buenosaires/prizes/symbiotic)
### About
...
📡 Best Use of Symbiotic Relay SDK ⸺ $10,000 🥇 1st place $4,000 🥈 2nd place $3,000 🥉 3rd place $2,000 🏅 4th place $1,000 We’re awarding $10,000 to the best builders using the Symbiotic Relay SDK!
...
<a href="https://ethglob.al/e2czw">Relay Quickstart https://docs2.symbiotic.fi/relay ↗</a> <a href="https://ethglob.al/im21q">Learn Symbiotic https://docs2.symbiotic.fi/learn ↗</a>
### Resources

<a href="https://ethglob.al/m5xtx">Hacker Guide https://symbioticfi.notion.site/Symbiotic-ETH-Global-Buenos-Aires-2a581c079c178078b7d3d0de88e71928 ↗</a>
### Workshop

### 🛠️ Build verifiable off-chain apps powered b...

Learn how to build and secure off-chain applications with Symbiotic Relay Apps – a framework for producing verifiab...

This workshop is happening in-person 05:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 5
...
[https](https://0g.ai/) [0g_labs](https://twitter.com/0G_labs) [Open page →](/events/buenosaires/prizes/0g)
### About
...
🤖  Building Onchain AI dapps with 0G intelligent L1 ⸺ $10,000 🥇 1st place $3,000 🥈 2nd place $2,500 🥉 3rd place $2,000 🏅 4th place $1,500 🏅 5th place $1,000 Build something impossible elsewhere. This track celebrates developers who push the boundaries of what's possible by leveraging 0G's groundbreaking infrastructure stack.
-------------------------------------
What We're Looking For:
...
<a href="https://ethglob.al/qb1vw">Builder Hub https://build.0g.ai ↗</a>
### Workshop

### Build an Onchain AI dapp with 0G's Inferencin...

Build decentralized AI applications using 0G's verifiable inferencing and also utilizing its complementary stack of...

This workshop is happening in-person 03:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 5

![Octav logo](https://ethglobal.b-cdn.net/organizations/qk38m/square-logo/default.png)

## Octav

$10,000

[octav.fi](https://octav.fi/) [octavfi](https://twitter.com/OctavFi) [Open page →](/events/buenosaires/prizes/octav)
### About
...
<a href="https://ethglob.al/byj3k">Documentation https://docs.octav.fi/ ↗</a>
### Resources

<a href="https://ethglob.al/cuoxk">Documentation https://docs.octav.fi/ ↗</a>
### Workshop

### 🛠️ Build Widgets with Octav API

Clarity for onchain human readable data is not always easy. 
Build widgets to help onchain user understand their po...

This workshop is happening in-person 03:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 1

![Anchorage Digital logo](https://ethglobal.b-cdn.net/organizations/hs9t7/square-logo/default.png)

## Anchorage Digital

$10,000

[anchorage.com](https://www.anchorage.com/) [anchorage](https://twitter.com/anchorage) [Open page →](/events/buenosaires/prizes/anchorage-digital)
### About
...
📈 Most Strategically Valuable Integration ⸺ $5,000 Using VisualSign the project must integrate with one of the "Top-Tier" protocols (example provided below). The prize will go to the top three teams with the best and most strategic use of VisualSign. This prize is not for the "coolest" or "most creative" hack, but is a targeted bounty to manufacture a high-quality, high-prestige case study. 
Please read the qualification requirements carefully.
### Qualification Requirements
...
🤝 Utilize VisualSign for dapps ⸺ $5,000 Up to 4 teams will receive $1,250 Use VisualSign across any dapp of your choice. The goal is to see all that VisualSign can interact with! We’re calling on builders to create with VisualSign across dapps, and to reimagine secure signing.
### Qualification Requirements
...
### 🛠️ Anchorage Digital Workshop

Stop Blind Signing With VisualSign. Enhance the security and clarity of your signing flows. Join Anchorage Digital ...

This workshop is happening in-person 05:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 2
...
[vlayer.xyz](https://www.vlayer.xyz/) [vlayer_xyz](https://twitter.com/vlayer_xyz) [Open page →](/events/buenosaires/prizes/vlayer)
### About
...
🪪 Best vouch Integration ⸺ $2,000 vouch enables applications to verify user-owned data from internet platforms without accessing or storing sensitive information. Using vouch’s existing data sources - or a new one you create - integrate vouch Web Proofs into your application to unlock privacy-preserving credentials and verification.
💡 Example Use Cases: 
...
🔧 BONUS TRACK: Build a Custom vouch Data Source ⸺ $1,000 Push the boundaries of what vouch can do by creating a brand new data source for the vouch catalog.
...
<a href="https://ethglob.al/zk55u">vlayer Documentation https://docs.vlayer.xyz/ ↗</a> <a href="https://ethglob.al/474o5">vouch Documentation https://docs.getvouch.io/ ↗</a> <a href="https://ethglob.al/n3ycv">vouch Catalog https://app.getvouch.io/catalog ↗</a> <a href="https://ethglob.al/dtuao">vouch SDK https://www.npmjs.com/package/@getvouch/sdk ↗</a> <a href="https://ethglob.al/ib9mk">vlayer Getting Started Tutorial https://docs.vlayer.xyz/server-side/examples/github-example ↗</a> <a href="https://ethglob.al/k0f4w">vouch Example Repo https://github.com/vlayer-xyz/vouch-github-verifier ↗</a> <a href="https://ethglob.al/r4ero">vlayer monorepo https://github.com/vlayer-xyz ↗</a>
![Self logo](https://ethglobal.b-cdn.net/organizations/ipmya/square-logo/default.png)

## Self

$10,000

[self.xyz](https://self.xyz/) [selfprotocol](https://twitter.com/selfprotocol) [Open page →](/events/buenosaires/prizes/self)
### About
...
🏆 Best Self onchain SDK integration ⸺ $9,000 🥇 1st place $5,000 🥈 2nd place $2,500 🥉 3rd place $1,500 Create a project that uses our onchain verification for disclosure proofs. We are looking for interesting use cases of using the Self onchain SDK in your contracts.
...
<a href="https://ethglob.al/hzerw">On Chain Integration Guide https://docs.self.xyz/contract-integration/basic-integration ↗</a> <a href="https://ethglob.al/xwn5i">Airdrop Example https://docs.self.xyz/contract-integration/airdrop-example ↗</a> <a href="https://ethglob.al/ts4js">Happy Birthday Example https://docs.self.xyz/contract-integration/happy-birthday-example ↗</a> <a href="https://ethglob.al/iw0mc">Soulbound Token Example https://github.com/selfxyz/self-sbt ↗</a> <a href="https://ethglob.al/sw9ik">Crosschain Example https://github.com/selfxyz/self-layerzero-example ↗</a> 🏆 Best Self offchain SDK Integration ⸺ $1,000 Create a project that uses our off chain/backend verification for disclosure proofs.
### Qualification Requirements
...
<a href="https://ethglob.al/nj1mk">Backend (offchain) Integration https://docs.self.xyz/backend-integration/basic-integration ↗</a>
### Resources

<a href="https://ethglob.al/cnouk">Website https://self.xyz/ ↗</a> <a href="https://ethglob.al/2wc9z">Docs https://docs.self.xyz/ ↗</a> <a href="https://ethglob.al/fsvqh">Playground https://playground.self.xyz/ ↗</a> <a href="https://ethglob.al/qyic7">Test Playground (for Mock Passports) https://playground.staging.self.xyz/ ↗</a> <a href="https://ethglob.al/88rcu">Celo Sepolia Faucet https://faucet.celo.org/celo-sepolia ↗</a> <a href="https://ethglob.al/bb28x">App - Google Play Store https://play.google.com/store/apps/details?id=com.proofofpassportapp&pli=1 ↗</a> <a href="https://ethglob.al/ovdzy">App - Apple Store (iOS) https://apps.apple.com/us/app/self-zk-passport-identity/id6478563710 ↗</a> <a href="https://ethglob.al/z1v6g">Self MCP Server https://github.com/selfxyz/self-mcp ↗</a>
...
[ethereum.foundation](https://ethereum.foundation/) [ethereumfndn](https://twitter.com/ethereumfndn) [Open page →](/events/buenosaires/prizes/ethereum-foundation)
### About
...
<a href="https://ethglob.al/2c8h4">EIL documentation http://docs.ethereuminteroplayer.com/ ↗</a>
### Workshop

### 🛠️ Ethereum Interop Layer (EIL) SDK Workshop

build and extend a real DeFi protocol using the EIL SDK. We’ll walk through the architecture, implement a complete ...

This workshop is happening in-person 05:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 3
...
[aboutcircles.com](https://www.aboutcircles.com/) [aboutcircles](https://twitter.com/aboutcircles) [Open page →](/events/buenosaires/prizes/circles)
### About
...
<a href="https://ethglob.al/2wvy4">Circles Relative Trust Score APIs https://squid-app-3gxnl.ondigitalocean.app/aboutcircles-advanced-analytics2/docs#/Scoring/batch_relative_trust_score_scoring_relative_trustscore_batch_post ↗</a> <a href="https://ethglob.al/uy6kt">Inspiration App Example https://world.org/ecosystem/app_ebdd8475db3238254fca5b25ccba266a ↗</a> 💵 Best dApp to build a x402 × Circles CRC checkout experience ⸺ $1,500 Build a checkout system that combines x402's HTTP-native payment protocol with Circles CRC tokens. Create a seamless payment experience where users can pay with personal or group CRC currencies, with payments automatically routed through the trust network to reach merchants. Implement this using Circles Organization accounts as payment processors that facilitate transactions and handle the x402 protocol layer for instant payment verification and settlement.
You can also choose to combine this with AI agents, which can either control Circle Organisation accounts or act on behalf of a human (e.g. as a co-signer in a safe registered as Human).
### Qualification Requirements

- Use of Circles SDK
- Full implementation from start to finish for the checkout experience

### Links and Resources

<a href="https://ethglob.al/yztzi">x402 https://x402.gitbook.io/x402 ↗</a> <a href="https://ethglob.al/4e0ua">Circles Org Account Docs https://docs.aboutcircles.com/developer-docs/circles-avatars/organization-avatars ↗</a>
### Resources

<a href="https://ethglob.al/23jha">Circles Documentation https://docs.aboutcircles.com/ ↗</a> <a href="https://ethglob.al/ux223">Circles App https://app.aboutcircles.com/ ↗</a> <a href="https://ethglob.al/yw89u">Metri Wallet https://app.metri.xyz/ ↗</a>
...
[rootstock.io](https://rootstock.io/) [rootstock_io](https://twitter.com/rootstock_io) [Open page →](/events/buenosaires/prizes/rootstock)
### About
...
🏆 Everyday DeFi ⸺ $2,000 Up to 2 teams will receive $1,000 Build practical DeFi applications on Rootstock and/or RIF technologies. We’re looking for accessible, efficient tools that redefine everyday finance, with a special emphasis on generating native bitcoin yield. 
...
🏆 Freestyle Track ⸺ $2,000 Up to 2 teams will receive $1,000 Build dapps on Rootstock and unleash your creativity. We’re looking for original solutions. Some examples include:
...
🏆 RIF Economy ⸺ $1,000 Build anything that puts the RIF token to work on Rootstock; bonus points for slick, one‑step UX and creative token utility.
...
<a href="https://ethglob.al/wzfbf">Developer Docs https://dev.rootstock.io/ ↗</a> <a href="https://ethglob.al/222ga">Hackathon Cheat Sheet https://cheatography.com/devrelrootstock/cheat-sheets/rootstock-hackathon/ ↗</a> <a href="https://ethglob.al/1h7tr">Hackathon Resources https://dev.rootstock.io/resources/hackathon/ ↗</a> <a href="https://ethglob.al/aqhzr">Quick Starts https://dev.rootstock.io/developers/quickstart/ ↗</a> <a href="https://ethglob.al/fr4dg">Replit Templates https://replit.com/@rootstockDevX ↗</a> <a href="https://ethglob.al/ngxno">Rootstock RPC API https://dev.rootstock.io/tools/rpc-api/ ↗</a> <a href="https://ethglob.al/mnqw7">Rootstock Explorer https://explorer.rootstock.io/ ↗</a> <a href="https://ethglob.al/z318d">How to get RBTC that you need to interact with the rootstock ecosystem https://blog.rootstock.io/noticia/smart-bitcoin-3-easy-ways-to-get-rbtc/ ↗</a> <a href="https://ethglob.al/hiqbr">How to port your Ethereum dapp to Rootstock https://dev.rootstock.io/kb/ethereum-dapp-to-rsk/ ↗</a> <a href="https://ethglob.al/a3o0x">RSKj for Developers https://dev.rootstock.io/kb/rskj-for-developers/ ↗</a> <a href="https://ethglob.al/tocm8">Developer Tooling https://dev.rootstock.io/dev-tools/ ↗</a>
### Workshop

### The Developer Gateway to Bitcoin’s DeFi

Rootstock is Bitcoin’s EVM-compatible sidechain, designed for builders who want to create decentralized apps secure...

This workshop is happening in-person 03:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 4

![Aztec logo](https://ethglobal.b-cdn.net/organizations/nhs1x/square-logo/default.png)

## Aztec

$5,000

[aztec.network](https://aztec.network/) [aztecnetwork](https://twitter.com/aztecnetwork) [Open page →](/events/buenosaires/prizes/aztec)
### About
...
<a href="https://ethglob.al/9sm53">Substance Labs (Intents) Github https://github.com/substance-labs/aztec-evm-bridge?tab=readme-ov-file ↗</a> <a href="https://ethglob.al/ax86u">Train (HTLC) Github https://github.com/TrainProtocol/contracts/tree/dev/chains/aztec ↗</a> <a href="https://ethglob.al/sk8gs">Train (HTLC) Docs https://docs.train.tech/protocol/introduction ↗</a> <a href="https://ethglob.al/ijwu4">Substance Labs (Intents) Docs https://substance-labs.gitbook.io/aztec-evm-bridge/ ↗</a> <a href="https://ethglob.al/jx71f">Wormhole (Messaging) Docs https://nethermind.notion.site/Wormhole-on-Aztec-documentation-Quick-Start-Guide-263360fc38d0804bba2afb4a33cbbca6 ↗</a> 🫆 Identity Infrastructure ⸺ $2,000 Only with native privacy can identity infrastructure work on-chain, because sensitive information simply cannot be exposed. Build on Aztec to create identity systems where people host credentials, attestations, or identity data that they can leverage across applications, whether on Aztec itself or composed cross-chain. This could be credential systems, DID infrastructure, verification mechanisms, aggregated attestations from multiple sources (like combining OpenBanking.nr and ZKPassport), or novel ways to prove facts about yourself without exposing everything.
### Qualification Requirements
...
<a href="https://ethglob.al/6yg84">ZKPassport https://zkpassport.id/ ↗</a> <a href="https://ethglob.al/b6r7m">ZKPassport Docs https://docs.zkpassport.id/intro ↗</a> <a href="https://ethglob.al/3p8hq">Anon Aadhaar https://github.com/anon-aadhaar/anon-aadhaar-noir ↗</a> <a href="https://ethglob.al/nuyif">Self https://github.com/selfxyz/self ↗</a> <a href="https://ethglob.al/arj8n">Rarimo https://github.com/rarimo/passport-zk-circuits-noir ↗</a> 🤯 Rethinking What's Possible ⸺ $1,000 Privacy unlocks a design space we haven't fully explored yet. We know there are applications that become possible with native privacy that we haven't seen before. Build the thing that makes us say 'oh wow, that's why privacy matters.' This could be gaming mechanics, governance systems, DeFi patterns we haven't seen, confidential business logic, or something we haven't thought of. The constraint is: it should only be possible because Aztec has native privacy.
### Qualification Requirements
...
<a href="https://ethglob.al/c4gnt">Aztec Horizon https://github.com/AztecProtocol/horizon ↗</a>
### Resources

<a href="https://ethglob.al/hdbx2">Awesome Aztec https://github.com/AztecProtocol/awesome-aztec ↗</a> <a href="https://ethglob.al/eci52">Awesome Noir https://github.com/noir-lang/awesome-noir ↗</a> <a href="https://ethglob.al/e9qzn">Aztec Documentation https://docs.aztec.network/devnet?utm_source=ethglobal&utm_medium=referral&utm_campaign=devconnect_2025 ↗</a> <a href="https://ethglob.al/6yd6i">Wonderland's Aztec Handbook https://aztec.handbook.wonderland.xyz/ ↗</a> <a href="https://ethglob.al/5u1wv">Aztec Starter https://github.com/AztecProtocol/aztec-starter ↗</a> <a href="https://ethglob.al/xv6sa">Aztec Resources 1-pager https://hackmd.io/@joshc/B1gp2dneZl ↗</a>
### Workshop

### 🛠️ Getting Started with Privacy App Developm...

Description coming soon..

This workshop is happening in-person 02:30 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 5
...
[privy.io](https://www.privy.io/) [privy_io](https://twitter.com/privy_io) [Open page →](/events/buenosaires/prizes/privy)
### About
...
<a href="https://ethglob.al/9ho9w">Session signers docs https://docs.privy.io/wallets/using-wallets/session-signers/overview ↗</a>
...
[curvegrid.com](http://www.curvegrid.com/) [curvegridinc](https://twitter.com/curvegridinc) [Open page →](/events/buenosaires/prizes/curvegrid)
### About
...
🏦 Best RWA Tokenization Project ⸺ $2,000 Turn real-world assets into programmable, composable digital primitives.
...
📄 Invoice Financing – Build tokenized invoice marketplaces with automated cashflow tracking
🏠 Real Estate Shares – Fractional ownership, secondary trading, or compliance-aware transfer logic
📦 Supply Chain Assets – Track movement, custody, and settlement by tokenizing commercial goods
🪙 Stablecoins – Create an interface for minting and managing stablecoins, including compliance aspects, yield tracking, or anything else you think useful in the stablecoin world
### Qualification Requirements
...
📊 Best Digital Asset Dashboard ⸺ $2,000 More and more people are managing portfolios of tokens, whether you’re an individual with personal investments, a VC with token agreements, or a business getting paid in tokens. Are there upcoming DAO votes? Actions to take for vesting tokens? How do you visualise your holdings in order to understand their value and take actions to manage them. MultiBaas provides the backend, you provide the dashboard!
 
💡 Some Ideas to Explore:
📊 RWA Analytics – How are RWAs performing including ownership distribution, valuations, and liquidity flows
🏦 Treasury Management – How do you track the assets in your portfolio and liquidate or exchange them efficiently in different markets
📈 DeFi Analytics – Real-time DEX activity, yield curves, liquidity movements
🌉 Cross-Chain Views – Compare assets or contracts across chains with unified views
### Qualification Requirements
...
<a href="https://ethglob.al/ubces">Quickstart Guide to MultiBaas https://docs.curvegrid.com/multibaas/getting-started/quickstart ↗</a>
### Workshop

### 🛠️ Build compliance enabled RWA projects wit...

These are not your parents’ tokens. Today’s tokens must meet the needs of complex regulatory frameworks and demandi...

This workshop is happening in-person 03:00 PM UTC-03 — Friday, Nov 21, 2025 in Workshop Room 2

![Babylon Labs logo](https://ethglobal.b-cdn.net/organizations/6162g/square-logo/default.png)

## Babylon Labs

$5,000

[babylonlabs.io](https://babylonlabs.io/) [Open page →](/events/buenosaires/prizes/babylon-labs)
### About
...
🎯 Bitcoin Trustless Vault in Ethereum DeFi ⸺ $5,000 🥇 1st place $2,500 🥈 2nd place $1,500 🥉 3rd place $1,000 - A concise 2–5 page concept note or design brief
...
<a href="https://ethglob.al/9mmwj">Bitcoin Trustless Vault Whitepaper https://docs.babylonlabs.io/papers/trustless-bitcoin-vaults.pdf ↗</a> <a href="https://ethglob.al/4y2hf">Babylon Staking Transactions Spec https://docs.babylonlabs.io/guides/specifications/staking_transactions/ ↗</a> <a href="https://ethglob.al/2qaj8">Bitcoin Wallet Integration https://docs.babylonlabs.io/developers/wallet_integration/bitcoin_wallet_integration/ ↗</a> <a href="https://ethglob.al/tris2">Babylon Genesis Chain https://docs.babylonlabs.io/developers/babylon_genesis_chain/ ↗</a>
...
[roninchain.com](https://roninchain.com/) [ronin_network](https://twitter.com/ronin_network) [Open page →](/events/buenosaires/prizes/ronin)
### About
...
🎉 Best Consumer/AI dApp on Ronin ⸺ $5,000 🥇 1st place $2,500 🥈 2nd place $1,500 🥉 3rd place $1,000 We’re looking for sticky, culture-driven tools/products — something fun, useful, and interactive, leveraging AI tools & Agents. 
E.g. 
...
<a href="https://ethglob.al/ei2ou">Get Mainnet RON https://docs.google.com/forms/d/e/1FAIpQLSdmQbqdkOXG4V9BKJ_M6lihIn-kUda-u85kQM5dgzYqoiLCog/viewform?usp=dialog ↗</a> <a href="https://ethglob.al/mtswd">TG Support https://t.me/+yZB8xadJ5gYwNGNk ↗</a>
### Resources

<a href="https://ethglob.al/5up41">TG Support Channel https://t.me/+yZB8xadJ5gYwNGNk ↗</a> <a href="https://ethglob.al/wxuk4">Ronin Network Information https://docs.roninchain.com/developers/network/ ↗</a> <a href="https://ethglob.al/0n7ik">Quickstart Guide https://docs.roninchain.com/developers/quickstart ↗</a> <a href="https://ethglob.al/prw2f">Ronin Dune Dashboard https://dune.com/ronin/ronin-overview-dashboard ↗</a>
![sqd logo](https://ethglobal.b-cdn.net/organizations/tbi2y/square-logo/default.png)

## sqd

$5,000

[sqd.ai](https://www.sqd.ai/) [hellosqd](https://twitter.com/helloSQD) [Open page →](/events/buenosaires/prizes/sqd)
### About
...
🏆 Best Overall Project using the Pipes SDK ⸺ $3,500 Your project must use the Pipes SDK in a meaningful way. 
...
<a href="https://ethglob.al/v2fp8">Pipes SDK https://github.com/subsquid-labs/pipes-sdk-docs ↗</a> 👩‍🎨 Most Creative/ Innovative Use Case of the Pipes SDK ⸺ $1,000 The Pipes SDK is used to pipe on-chain data from our decentralised data lake into any unique application, they usually power analytics dashboards or trading terminals. 
...
<a href="https://ethglob.al/smy1z">Pipes SDK https://github.com/subsquid-labs/pipes-sdk-docs ↗</a> 🦑 Most Degen Use Case of Pipes SDK ⸺ $500 The most speculative/ degenerative use case of the pipes SDK. Think of the most trench friendly application, how would data pipelines power this?
### Qualification Requirements
...
<a href="https://ethglob.al/csugi">Pipes SDK https://github.com/subsquid-labs/pipes-sdk-docs ↗</a>
### Resources

<a href="https://ethglob.al/4au7y">Pipes SDK https://github.com/subsquid-labs/pipes-sdk-docs ↗</a>
### Jobs

<a href="/jobs/technical-devrel-umdum">Technical DevRel sqd →</a>
![Espresso logo](https://ethglobal.b-cdn.net/organizations/vpq6s/square-logo/default.png)

## Espresso

$5,000

[espressosys.com](https://www.espressosys.com/) [espressosys](https://twitter.com/EspressoSys) [Open page →](/events/buenosaires/prizes/espresso)
### About
...
🏆 Best Cross-Chain App Deployed on ANY Espresso-integrated chain ⸺ $5,000 🥇 1st place $2,500 🥈 2nd place $1,500 🥉 3rd place $1,000 Best Cross-Chain Application deployed on ANY Espresso-integrated chain (Celo, ApeChain, Rari, Appchain, Molten, T3rn, NodeOps, Rufus, Huddle01, LogX).
### Qualification Requirements
...
<a href="https://ethglob.al/s7e86">What is Espresso? https://docs.espressosys.com/network ↗</a> <a href="https://ethglob.al/ci5aj">Reading from the Espresso Network https://docs.espressosys.com/network/concepts/read-from-network ↗</a> <a href="https://ethglob.al/5e43k">Telegram - Hacker Support Chat https://tr.ee/U2WKWL ↗</a>
### Resources

<a href="https://ethglob.al/5zwse">Telegram - Hacker Support Group https://tr.ee/U2WKWL ↗</a>
...
[xmtp.org](https://xmtp.org/) [xmtp_](https://twitter.com/xmtp_) [Open page →](/events/buenosaires/prizes/xmtp)
### About
...
📲 Best Miniapp in a Group Chat ⸺ $2,500 build something your group of friends would actually use every day: to play, trade, vote, bet, share, or just have fun together.
### Qualification Requirements
...
<a href="https://ethglob.al/k0wod">Miniapps in Chat https://xmtp.org/miniapps ↗</a> <a href="https://ethglob.al/v23sp">Mini app in chat starter https://github.com/ephemeraHQ/xmtp-mini-app-example ↗</a> 🤖 Best Use of the Agent SDK ⸺ $2,500 Whether standalone or paired with a miniapp, show how agents can make chats smarter, more useful, or more fun.
### Qualification Requirements

Agent demos must be built in the Base app and use at least one supported content type: attachments, transactions, or inline actions.

### Links and Resources

<a href="https://ethglob.al/6nsm3">Agent examples https://github.com/ephemeraHQ/xmtp-agent-examples ↗</a>
### Resources

<a href="https://ethglob.al/31ji6">XMTP Documentation https://docs.xmtp.org/agents/get-started/build-an-agent ↗</a> <a href="https://ethglob.al/7rqoj">Chat agents in the Base App https://docs.base.org/base-app/agents/chat-agents ↗</a> <a href="https://ethglob.al/7806u">Agent examples https://github.com/ephemeraHQ/xmtp-agent-examples ↗</a> <a href="https://ethglob.al/j8u9d">Workshop https://www.youtube.com/watch?v=djRLnWUvwIA&t=440s ↗</a>
### Workshop

<a href="https://www.youtube.com/watch?v=djRLnWUvwIA"></a> [Watch Video →](https://www.youtube.com/watch?v=djRLnWUvwIA)