...
export function PromptInputAttachment({
	...
	const isImageWithUrl = data.mediaType?.startsWith("image/") && data.url;
	const mediaType = isImageWithUrl ? "image" : "file";
...
export const PromptInputButton = ({
	...
	const hasMultipleChildren = Children.count(props.children) > 1;
	const defaultSize = hasMultipleChildren ? "sm" : "icon-sm";
