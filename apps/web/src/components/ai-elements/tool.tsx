...
/**
 * Extended tool state type that includes approval states
 * These states were removed from the ai package but are still used for approval workflows
 */
...
const getStatusBadge = (status: ExtendedToolState) => {
	...
	const icons: Record<ExtendedToolState, ReactNode> = {
		...
		"output-denied": <XCircleIcon className="size-4 text-accent" />,
	};
